...
class TestCRSFProtocol:
    ...
    def test_center_channels_produce_correct_frame(self):
        ...
        expected = bytes.fromhex(
            "c8 18 16 e0 03 1f f8 c0 07 3e f0 81 0f 7c e0 03 1f f8 c0 07 3e f0 81 0f 7c ad"
        )
    ...
    def test_all_min_channels(self):
        ...
        expected = bytes.fromhex(
            "c8 18 16 ac 60 05 2b 58 c1 0a 56 b0 82 15 ac 60 05 2b 58 c1 0a 56 b0 82 15 5b"
        )
        assert frame == expected
    ...
    def test_all_max_channels(self):
        ...
        expected = bytes.fromhex(
            "c8 18 16 13 9f f8 c4 27 3e f1 89 4f 7c e2 13 9f f8 c4 27 3e f1 89 4f 7c e2 b9"
        )
        assert frame == expected
    ...
    def test_varied_channels(self):
        ...
        expected = bytes.fromhex(
            "c8 18 16 ac 60 89 70 b0 e4 2e c2 81 8f 89 e2 c4 ab 83 49 3d 71 90 a1 8f 3e 3e"
        )
        assert frame == expected
